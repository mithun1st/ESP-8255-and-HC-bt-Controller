...
public class vs extends javax.swing.JFrame {
    ...
    private void stream(){
        try {
            OpenCVFrameGrabber frameGrabber = new OpenCVFrameGrabber(jTextField1.getText().trim()+"?.mjpg");
            frameGrabber.setFormat("mjpeg");
            frameGrabber.start();
            opencv_core.IplImage iPimg = frameGrabber.grab();
            CanvasFrame canvasFrame = new CanvasFrame("Video Streaming - develop by Mahadi Hassan");
    ...
    private void initComponents() {
        ...
        setTitle("Video Streaming Develop By Mithun");
